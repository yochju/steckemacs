...
| C-h M-RET         | Open      | Emacs Web Wowser do what I mean                           | 'stk/eww-browse-dwim                                        |
...
(defun stk/configure-term ()
    (interactive)
    (setq truncate-lines 1)
    (define-key term-raw-map (kbd "C-c y") 'term-paste))
(add-hook 'term-mode-hook 'stk/configure-term t)
#+END_SRC
