...
| C-h C-y           | Find/Grep | Projectile find file                                      | 'projectile-find-file                                       |
...
Flycheck is written by [[http://lunaryorn.com/][Sebastian Wiesner]] a.k.a =lunaryorn=.
...
Enhance =gfm-mode= with liquid keywords hightlighting and enable =gfm-liquid-mode= when the file suffixes match.
