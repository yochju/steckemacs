...
|-------------------+-----------+-----------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------|
| C-c X             | General   | Kill emacs (including the daemon if it is running)        | (lambda () (interactive) (shell-command "pkill emacs"))                                                                                    |
...
| C-h C-c           | General   | Helm M-x (execute command)                                | 'helm-M-x                                                                                                                                  |
| C-c h             | General   | Helm navigate project files                               | 'helm-projectile                                                                                                                           |
...
| C-c q             | Editing   | toggles word wrap                                         | 'auto-fill-mode                                                                                                                            |
...
| C-h C-v           | Source    | Go to the definition of the variable under cursor         | 'find-variable-at-point                                                                                                                    |
...
| eb                | Buffers   | Evaluate the current buffer                               | 'eval-buffer                                                                                                                               |
...
| C-h C-s           | Find/Grep | Projectile find file                                      | 'projectile-find-file                                                                                                                      |
| C-h C-r           | Find/Grep | Projectile grep                                           | 'projectile-grep                                                                                                                           |
| aw                | Find/Grep | Projectile ack                                            | 'projectile-ack                                                                                                                            |
