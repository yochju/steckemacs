...
| C-x C-u           | Internet  | Prompt for URL and insert contents at point               | 'stk/url-insert-file-contents                                                                                                              | global    |
| C-c C-w           | Internet  | Browse URL under cursor                                   | 'browse-url-at-point                                                                                                                       | global    |
| gt                | Internet  | Google "this"                                             | 'google-this                                                                                                                               | key-chord |
| gs                | Internet  | Google search                                             | 'google-search                                                                                                                             | key-chord |
| C-z               | Editing   | Undo - but do not trigger redo                            | 'undo-only                                                                                                                                 | global    |
...
| i9                | Editing   | Toggle electric indent mode                               | 'electric-indent-mode                                                                                                                      | key-chord |
| C-c i             | Editing   | indent the whole the buffer                               | (lambda () (interactive) (indent-region (point-min) (point-max)))                                                                          | global    |
| ac                | Editing   | Align nearby elements                                     | 'align-current                                                                                                                             | key-chord |
| C-8               | Editing   | Select symbol under cursor, repeat to expand              | 'er/expand-region                                                                                                                          | global    |
| M-8               | Editing   | Contract the current selection                            | 'er/contract-region                                                                                                                        | global    |
| M-W               | Editing   | Delete region (but don't put it into kill ring)           | 'delete-region                                                                                                                             | global    |
| fc                | Editing   | Toggle flycheck mode                                      | 'flycheck-mode                                                                                                                             | key-chord |
| C-c q             | Editing   | toggles word wrap                                         | 'auto-fill-mode                                                                                                                            | global    |
| C-c w             | Editing   | cleanup whitespaces                                       | 'whitespace-cleanup                                                                                                                        | global    |
...
| M-5               | Source    | Helm select etags                                         | 'helm-etags-select                                                                                                                         | global    |
| M-6               | Source    | Find tag in a new window                                  | 'find-tag-other-window                                                                                                                     | global    |
...
| M-7               | History   | Helm show the kill ring                                   | 'helm-show-kill-ring                                                                                                                       | global    |
| C-5               | History   | Helm show all mark rings                                  | 'helm-all-mark-rings                                                                                                                       | global    |
| C-3               | History   | Go backward in movement history                           | 'back-button-local-backward                                                                                                                | global    |
| C-4               | History   | Go forward in movement history                            | 'back-button-local-forward                                                                                                                 | global    |
...
| <M-up>            | Windows   | Move the current buffer window up                         | 'buf-move-up                                                                                                                               | global    |
| <M-down>          | Windows   | Move the current buffer window down                       | 'buf-move-down                                                                                                                             | global    |
| <M-left>          | Windows   | Move the current buffer window left                       | 'buf-move-left                                                                                                                             | global    |
| <M-right>         | Windows   | Move the current buffer window right                      | 'buf-move-right                                                                                                                            | global    |
...
| C-x f             | Find/Grep | Projectile find file                                      | 'projectile-find-file                                                                                                                      | global    |
...
| C-c c             | Open      | Open deft (quick notes tool)                              | 'deft                                                                                                                                      | global    |
| C-c s             | Open      | Open emacs shell                                          | 'shell                                                                                                                                     | global    |
| nm                | Open      | Open mu4e                                                 | 'mu4e                                                                                                                                      | key-chord |
| C-c A             | Open      | Org mode capture (todo)                                   | 'org-capture                                                                                                                               | global    |
| C-c a             | Open      | Open Org mode agenda                                      | (lambda () (interactive) (org-agenda nil "n"))                                                                                             | global    |
| C-c e             | Open      | Open/connect with  ERC                                    | (lambda () (interactive) (erc-tls :server erc-server :port erc-port :nick erc-nick :full-name erc-user-full-name :password erc-password )) | global    |
