...
To get the latest org-mode I set =package-archives= to contain [[http://orgmode.org/][org-mode.org]] archive. The built-in GNU ELPA is overwritten with tha because it often timed out and annoyed me.
...
I forgot that I even have this. I hope it doesn't blow me Emacs up.

Github: https://github.com/kentaro/auto-save-buffers-enhanced

#+BEGIN_SRC emacs-lisp
(quelpa '(auto-save-buffers-enhanced :repo "kentaro/auto-save-buffers-enhanced" :fetcher github))
...
So yeah, looks like the defaults pretty much. It can't hurt.
...
(quelpa '(helm-git :repo maio/helm-git :fetcher github))
...
#+BEGIN_SRC emacs-lisp
(quelpa '(magit :fetcher github :repo magit/magit :files (magit.el magit-bisect.el magit-blame.el magit-key-mode.el magit-popup.el magit-wip.el magit.texi AUTHORS.md README.md)))
