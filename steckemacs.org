...
(if (require 'quelpa nil t)
    (quelpa '(quelpa :repo "quelpa/quelpa" :fetcher github :branch "url-fetcher-feature") :upgrade t)
  (with-temp-buffer
    (url-insert-file-contents "https://raw.github.com/quelpa/quelpa/master/bootstrap.el")
    (eval-buffer))
  (quelpa '(quelpa :repo "quelpa/quelpa" :fetcher github :branch "url-fetcher-feature") :upgrade t) ;upgrade to the fetcher branch immediately
  (load-library "quelpa"))
#+END_SRC
...
(setf (cdr (assoc "\\.pdf\\'" org-file-apps)) 'emacs) ; use emacs to open pdf
