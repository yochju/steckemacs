...
What I want I usually want is to have Emacs increase or decrease the text size for the whole frame (with mode-line and mini-buffer). There is nothing built in that can do that so I use this library.
