...
#+HTML_HEAD: <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
#+HTML_HEAD: <script src="/stuff/js/bootstrap.min.js"></script>
#+INFOJS_OPT: view:showall toc:t ftoc:t mouse:#555555
...
#+BEGIN_SRC emacs-lisp :noweb yes :exports none :tangle README.org
  <<usage()>>
#+END_SRC
* Usage
